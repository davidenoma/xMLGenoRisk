...
params = {'booster': 'gblinear',"objective":"binary:logistic", 'max_depth': 5, 'lambda': 0.030475097247617086, 'alpha': 753658128510404e-05}

cv_results = xgb.cv(dtrain=d, params=params, nfold=4, num_boost_round=50, early_stopping_rounds=10,metrics="auc", as_pandas=True, seed=234)
cv_results

"""## Using parameters from Recall"""

params = {'booster': 'dart', 'lambda': 8.669790267915281e-07, 'alpha': 1.1536382592082632e-08, 'subsample': 0.28469669085250404, 'colsample_bytree': 0.5566590888822147, 
          'max_depth': 7, 'min_child_weight': 10, 'eta': 0.003933096882701822, 'gamma': 0.0018015367008443472, 'grow_policy': 'lossguide', 'sample_type': 'weighted', 
